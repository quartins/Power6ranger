...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(131, 41);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(600, 750);
			this->pictureBox1->SizeMode = System::Windows::Forms::PictureBoxSizeMode::StretchImage;
			this->pictureBox1->TabIndex = 1;
			this->pictureBox1->TabStop = false;
			this->pictureBox1->Click += gcnew System::EventHandler(this, &MoneyShow::pictureBox1_Click);
			// 
			// pictureBox2
			// 
			...
			this->pictureBox2->Click += gcnew System::EventHandler(this, &MoneyShow::pictureBox2_Click);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(764, 426);
